...
//    layout.addComponent(lbl);
    ...
    horl.addComponent(makeChildGroupButton("Expand", (CardListEntry) message, CardType.getExpandType(MobileVHib.getVHSession()), messageList));
    horl.addComponent(makeChildGroupButton("Counter", (CardListEntry) message, CardType.getCounterType(MobileVHib.getVHSession()), messageList));
    horl.addComponent(makeChildGroupButton("Adapt", (CardListEntry) message, CardType.getAdaptType(MobileVHib.getVHSession()), messageList));
    horl.addComponent(makeChildGroupButton("Explore", (CardListEntry) message, CardType.getExploreType(MobileVHib.getVHSession()), messageList));
  }

  @SuppressWarnings("serial")
  private Component makeChildGroupButton(final String title, CardListEntry card, CardType typ, final ListView currentMessageList)
  {
