/*
  Copyright (C) 2014 Modeling Virtual Environments and Simulation (MOVES)
  Institute at the Naval Postgraduate School (NPS)
  ...
  along with this program, in the form of files named COPYING and
